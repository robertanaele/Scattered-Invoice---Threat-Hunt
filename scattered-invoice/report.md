...
![Q04 MFA Denial Error Code](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q04_MFA_Denial_Error_Code.png)

📷 *Evidence 3. MFA-related sign-in event showing denied or incomplete strong authentication attempts.*

![Q05 MFA Fatigue Intensity](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q05_MFA_Fatigue_Intensity.png)
...
![Q06 Application Accessed](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q06_Application_Accessed.png)
...
![Q07 Attacker Operating System](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q07_Attacker_Operating_System.png)

📷 *Evidence 6. Device fingerprint data identifying Linux as the operating system used during attacker authentication.*

![Q08 Attacker Browser](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q08_Attacker_Browser.png)
...
![Q09 First Post-Auth Action](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q09_First_Post_Auth_Auction.png)
...
![Q10 Rule Creation Method](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q10_Rule_Creation_Method.png)
...
![Q11 Forward Rule Name](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q11_Forward_Rule_Name.png)

📷 *Evidence 10. Malicious forwarding rule name configured as `.` to avoid casual detection.*

![Q12 Forward Destination](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q12_Forward_Destination.png)

📷 *Evidence 11. External forwarding destination configured as `insights@duck.com`.*

![Q13 Forward Keywords](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q13_Forward_Keywords.png)

📷 *Evidence 12. Financially themed trigger keywords used to capture invoice and payment-related messages.*

![Q14 Rule Processing Flag](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q14_Rule_Processing_Flag.png)
...
![Q15 Delete Rule Name](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q15_Delete_Rule_Name.png)

📷 *Evidence 14. Malicious deletion rule name configured as `..` to remain visually inconspicuous.*

![Q16 Delete Keywords](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q16_Delete_Keywords.png)
...
![Q17 BEC Target](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q17_BEC_Target.png)

📷 *Evidence 16. Email telemetry identifying the target recipient of the fraudulent BEC message.*

![Q18 BEC Subject Line](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q18_BEC_Subject_Line.png)

📷 *Evidence 17. Subject line evidence showing invoice-thread hijacking using updated banking details.*

![Q19 Email Direction](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q18_BEC_Subject_Line.png)
...
![Q21 Cloud App Accessed](https://github.com/robertanaele/Scattered-Invoice---Threat-Hunt/blob/main/scattered-invoice/screanshoots/Q21_Cloud_App_Accessed.png)
